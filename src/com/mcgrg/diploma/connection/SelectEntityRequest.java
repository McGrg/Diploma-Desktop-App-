...
public class SelectEntityRequest<T> {
    public List<T> setRequest(Type itemListType, String columnname) throws HttpRequest.HttpRequestException {
        ...
        String strRequest = "SELECT " + columnname + " FROM diploma." + tablename + ";";
