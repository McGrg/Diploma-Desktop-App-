...
public class InsertEntityRequest<T> {
    public void setRequest(Type itemListType, String target, String value) throws HttpRequest.HttpRequestException {
        ...
        String strRequest = "INSERT INTO diploma." + tablename + " ( " + target + " ) Values( " + value + " );";
